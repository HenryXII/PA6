...
public class PublicTester {
        ...
        public void testExpandCapacity() {
                MyDeque<Integer> deque = new MyDeque<>(10);
                Integer[] orig = { 5, 6, 1, null, null, null, null, null, null,
                                null };
                Integer[] finalOrdering = { 5, 6, 1, null, null, null, null,
                ...
                assertEquals("Capacity should have doubled", 20,
                                deque.data.length);
        ...
        /**
         * Test addFirst to deque containing several elements in the middle of
         * the array
         */
        @Test
        public void testAddFirst() {
                MyDeque<Integer> deque = new MyDeque<>(10);
                Integer[] orig = { null, null, null, 4, 5, 6, null, null, null,
                                null };
                ...
                assertEquals("Index 3 should not have changed",
                                Integer.valueOf(4), deque.data[3]);
                assertEquals("Index 4 should not have changed",
                                Integer.valueOf(5), deque.data[4]);
                assertEquals("Index 5 should not have changed",
                                Integer.valueOf(6), deque.data[5]);
        }

        /**
         * Test addLast to deque containing several elements in the middle of
         * the array
         */
        @Test
        public void testAddLast() {
                MyDeque<Integer> deque = new MyDeque<>(10);
                Integer[] orig = { null, null, 4, 5, 1, null, null, null, null,
                                null };
                ...
                assertEquals("Index 2 should not have changed",
                                Integer.valueOf(4), deque.data[2]);
                assertEquals("Index 3 should not have changed",
                                Integer.valueOf(5), deque.data[3]);
                assertEquals("Index 4 should not have changed",
                                Integer.valueOf(1), deque.data[4]);
        }
        ...
        public void testRemoveFirst() {
                MyDeque<Integer> deque = new MyDeque<>(10);
                Integer[] orig = { null, 3, 4, 1, null, null, null, null, null,
                                null };
                ...
                assertEquals("Front should move one index after removing from "
                                + "non-empty deque", 2, deque.front);
                assertEquals("Rear should not change after calling removeFirst",
                                3, deque.rear);
                assertEquals("Index 2 should remain unchanged",
                                Integer.valueOf(4), deque.data[2]);
                assertEquals("Index 3 should remain unchanged",
                                Integer.valueOf(1), deque.data[3]);
        ...
        public void testRemoveLast() {
                ...
                assertEquals("Array length shouldn't be changed", 10,
                                deque.data.length);
                assertEquals("Size should decrement", 2, deque.size);
                assertEquals("Front should not change after calling removeLast",
                                1, deque.front);
                assertEquals("Rear should move one index after removing from "
                                + "non-empty deque", 2, deque.rear);
                assertEquals("Index 1 should remain unchanged",
                                Integer.valueOf(3), deque.data[1]);
                assertEquals("Index 2 should remain unchanged",
                                Integer.valueOf(4), deque.data[2]);
        ...
        public void testPeekFirst() {
                ...
                assertEquals("peekFirst should not change front", 0,
                                deque.front);
        ...
        /**
         * Test peekLast from deque containing several elements in the middle of
         * the array
         */
        @Test
        public void testPeekLast() {
                MyDeque<Integer> deque = new MyDeque<>(10);
                Integer[] orig = { 3, 5, 2, null, null, null, null, null, null,
                                null };
                ...
                assertEquals("peekLast should not change front", 0,
                                deque.front);
        ...
        public void testStackEmpty() {
                ...
                assertEquals("Capacity should not have changed", 10,
                                stack.theStack.data.length);
                assertEquals("Size should not have changed", 0,
                                stack.theStack.size);
                assertEquals("Front should not have changed", 0,
                                stack.theStack.front);
                assertEquals("Rear should not have changed", 0,
                                stack.theStack.rear);
        }
        ...
        public void testStackPush() {
                ...
                assertEquals("Capacity should not have changed", 10,
                                stack.theStack.data.length);
                assertEquals("Size should be incremented", 1,
                                stack.theStack.size);
                assertEquals("Front should not have changed", 0,
                                stack.theStack.front);
                assertEquals("Rear should not have changed", 0,
        ...
        public void testStackPop() {
                MyStack<Integer> stack = new MyStack<>(10);
                Integer[] orig = { 1, 2, 3, null, null, null, null, null, null,
                                null };
        ...
        public void testStackPeek() {
                ...
                assertEquals("Front should not have changed", 0,
                                stack.theStack.front);
                assertEquals("Rear should not have changed", 2,
                                stack.theStack.rear);
        }
